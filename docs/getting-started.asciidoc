...
:pharstable:  http://bartlett.laurent-laville.org/get/umlwriter-1.0.0.phar
...
[source,bash]
----
$ chmod +x umlwriter-1.0.0.phar
$ mv umlwriter-1.0.0.phar /usr/local/bin/umlwriter
...
[source,bash]
----
$ wget http://bartlett.laurent-laville.org/get/umlwriter-1.0.0.phar
$ php umlwriter-1.0.0.phar --version
----
...
[source,bash]
----
$ php composer.phar create-project bartlett/umlwriter /path/to/install 1.0.0
----
